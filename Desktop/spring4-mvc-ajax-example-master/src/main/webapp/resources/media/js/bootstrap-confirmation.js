	...
	* ======================= */
	...
	$.fn.confirmation.defaults = $.extend({} , $.fn.tooltip.defaults, {
		...
		, template: '<div class="popover">' +
				...
				'<div class="btn-group">' +
				'<a class="btn" href="" target=""></a>' +
				'<a class="btn btn-default" data-dismiss="confirmation"></a>' +
				'</div>' +
				'</div>' +
				'</div>'
		, btnOkClass:  'btn-primary'
		, btnCancelClass:  ''
		, btnOkLabel: '<i class="glyphicon glyphicon-ok-sign"></i> Yes'
		, btnCancelLabel: '<i class="glyphicon glyphicon-remove-sign"></i> No'
		, singleton: false
		, popout: false
		, onConfirm: function(){}
		, onCancel: function(){}
