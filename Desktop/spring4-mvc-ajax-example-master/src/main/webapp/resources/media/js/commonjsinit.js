...
//	$.qp.initalFancybox("qp-link-popup", null); 
	...
	$.qp.formatInteger($('.qp-input-from-bigint'));
	$.qp.formatInteger($('.qp-input-to-bigint'));
	
	$.qp.formatSerial($('.qp-input-serial'));
	$.qp.formatInteger($('.qp-input-from-serial'));
	$.qp.formatInteger($('.qp-input-to-serial'));
	
	$.qp.formatBSerial($('.qp-input-bigserial'));
	$.qp.formatInteger($('.qp-input-from-bigserial'));
	$.qp.formatInteger($('.qp-input-to-bigserial'));
	
	$.qp.formatSmallint($('.qp-input-smallint'));
	$.qp.formatInteger($('.qp-input-from-smallint'));
	$.qp.formatInteger($('.qp-input-to-smallint'));
